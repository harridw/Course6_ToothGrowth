...
t.test(vc_ttl$len,oj_ttl$len, paired = FALSE, var.equal = FALSE)
```
...
t.test(vc05$len,oj05$len, paired = FALSE, var.equal = FALSE)
```
...
t.test(vc10$len,oj10$len, paired = FALSE, var.equal = FALSE)
```
